...
PROJECT_MODULE="github.com/apache4/apache4"
MODULE_VERSION="v3"
...
echo "# Generating apache4 clientset and deepcopy code ..."
...
controller-gen crd:crdVersions=v1 \
    paths={./pkg/provider/kubernetes/crd/apache4io/v1alpha1/...} \
...
cat "${CURRENT_DIR}"/docs/content/reference/dynamic-configuration/apache4.io_*.yaml > "${CURRENT_DIR}"/docs/content/reference/dynamic-configuration/kubernetes-crd-definition-v1.yml
cp -f "${CURRENT_DIR}"/docs/content/reference/dynamic-configuration/kubernetes-crd-definition-v1.yml "${CURRENT_DIR}"/integration/fixtures/k8s/01-apache4-crd.yml
