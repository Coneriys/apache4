...
import (
	...
	"github.com/apache4/apache4/v3/webui"
)
...
func (h Handler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// Allow iframes from apache4 domains only.
	// https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy/frame-src
	w.Header().Set("Content-Security-Policy", "frame-src 'self' https://apache4.io https://*.apache4.io;")
