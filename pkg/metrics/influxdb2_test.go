...
func TestInfluxDB2(t *testing.T) {
	...
	expectedServer := []string{
		`(apache4\.config\.reload\.total count=1) [\d]{19}`,
		`(apache4\.config\.reload\.lastSuccessTimestamp value=1) [\d]{19}`,
		`(apache4\.open\.connections,entrypoint=test,protocol=TCP value=1) [\d]{19}`,
	}
	...
	expectedTLS := []string{
		`(apache4\.tls\.certs\.notAfterTimestamp,key=value value=1) [\d]{19}`,
	}
	...
	expectedEntrypoint := []string{
		`(apache4\.entrypoint\.requests\.total,code=200,entrypoint=test,method=GET count=1) [\d]{19}`,
		`(apache4\.entrypoint\.requests\.tls\.total,entrypoint=test,tls_cipher=bar,tls_version=foo count=1) [\d]{19}`,
		`(apache4\.entrypoint\.request\.duration(?:,code=[\d]{3})?,entrypoint=test p50=10000,p90=10000,p95=10000,p99=10000) [\d]{19}`,
		`(apache4\.entrypoint\.requests\.bytes\.total,code=200,entrypoint=test,method=GET count=1) [\d]{19}`,
		`(apache4\.entrypoint\.responses\.bytes\.total,code=200,entrypoint=test,method=GET count=1) [\d]{19}`,
	}
	...
	expectedRouter := []string{
		`(apache4\.router\.requests\.total,code=200,method=GET,router=demo,service=test count=1) [\d]{19}`,
		`(apache4\.router\.requests\.total,code=404,method=GET,router=demo,service=test count=1) [\d]{19}`,
		`(apache4\.router\.requests\.tls\.total,router=demo,service=test,tls_cipher=bar,tls_version=foo count=1) [\d]{19}`,
		`(apache4\.router\.request\.duration,code=200,router=demo,service=test p50=10000,p90=10000,p95=10000,p99=10000) [\d]{19}`,
		`(apache4\.router\.requests\.bytes\.total,code=200,method=GET,router=demo,service=test count=1) [\d]{19}`,
		`(apache4\.router\.responses\.bytes\.total,code=200,method=GET,router=demo,service=test count=1) [\d]{19}`,
	}
	...
	expectedService := []string{
		`(apache4\.service\.requests\.total,code=200,method=GET,service=test count=1) [\d]{19}`,
		`(apache4\.service\.requests\.total,code=404,method=GET,service=test count=1) [\d]{19}`,
		`(apache4\.service\.requests\.tls\.total,service=test,tls_cipher=bar,tls_version=foo count=1) [\d]{19}`,
		`(apache4\.service\.request\.duration,code=200,service=test p50=10000,p90=10000,p95=10000,p99=10000) [\d]{19}`,
		`(apache4\.service\.server\.up,service=test,url=http://127.0.0.1 value=1) [\d]{19}`,
		`(apache4\.service\.requests\.bytes\.total,code=200,method=GET,service=test count=1) [\d]{19}`,
		`(apache4\.service\.responses\.bytes\.total,code=200,method=GET,service=test count=1) [\d]{19}`,
	}
	...
	expectedServiceRetries := []string{
		`(apache4\.service\.retries\.total,service=test count=2) [\d]{19}`,
		`(apache4\.service\.retries\.total,service=foobar count=1) [\d]{19}`,
	}
