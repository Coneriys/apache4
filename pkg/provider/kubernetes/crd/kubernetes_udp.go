...
func (p *Provider) createLoadBalancerServerUDP(client Client, parentNamespace string, service apache4v1alpha1.ServiceUDP) (*dynamic.UDPService, error) {
	ns := parentNamespace
...
func (p *Provider) loadUDPServers(client Client, namespace string, svc apache4v1alpha1.ServiceUDP) ([]dynamic.UDPServer, error) {
