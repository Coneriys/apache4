...
type Provider struct {
	Insecure          bool `description:"Activate REST Provider directly on the entryPoint named apache4." json:"insecure,omitempty" toml:"insecure,omitempty" yaml:"insecure,omitempty" export:"true"`
