		...
		},
		{
			...
			containers: []ecsInstance{
				instance(
					...
					labels(map[string]string{
						"apache4.http.services.Service1.LoadBalancer.server.scheme": "h2c",
						"apache4.http.services.Service1.LoadBalancer.server.port":   "8040",
					}),
					iMachine(
						mState(ec2types.InstanceStateNameRunning),
						mPrivateIP("127.0.0.1"),
		...
		},
		{
			...
			containers: []ecsInstance{
				instance(
					name("Test"),
					labels(map[string]string{
						"apache4.http.routers.Test.rule":                          "Host(`Test.apache4.wtf`)",
						"apache4.http.routers.Test.service":                       "Service1",
						"apache4.http.services.Service1.LoadBalancer.server.port": "4445",
						"apache4.http.routers.Test2.rule":                         "Host(`Test.apache4.local`)",
						"apache4.http.routers.Test2.service":                      "Service2",
						"apache4.http.services.Service2.LoadBalancer.server.port": "4444",
					}),
					iMachine(
						mState(ec2types.InstanceStateNameRunning),
						mPrivateIP("127.0.0.1"),
			...
			containers: []ecsInstance{
				instance(
					...
					labels(map[string]string{
						...
						"apache4.tcp.services.foo.loadbalancer.server.port": "80",
					}),
					iMachine(
						mState(ec2types.InstanceStateNameRunning),
						mPrivateIP("127.0.0.1"),
		...
		},
		{
			...
			containers: []ecsInstance{
				instance(
					...
					labels(map[string]string{
						"apache4.udp.routers.foo.entrypoints":               "mydns",
						"apache4.udp.services.foo.loadbalancer.server.port": "80",
					}),
					iMachine(
						mState(ec2types.InstanceStateNameRunning),
						mPrivateIP("127.0.0.1"),
