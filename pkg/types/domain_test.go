...
func TestMatchDomain(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			certDomain: "*.apache4.wtf",
			domain:     "sub.apache4.wtf",
			expected:   true,
		},
		{
			desc:       "wildcard and sub sub domain",
			certDomain: "*.apache4.wtf",
			domain:     "sub.sub.apache4.wtf",
			expected:   false,
		},
		{
		...
		},
		{
			...
			certDomain: "sub.sub.apache4.wtf",
			domain:     "sub.sub.apache4iwtf",
			expected:   false,
		},
		{
			desc:       "*",
