...
type EntryPoint struct {
	...
	Transport        *EntryPointsTransport `description:"Configures communication between clients and apache4." json:"transport,omitempty" toml:"transport,omitempty" yaml:"transport,omitempty" export:"true"`
...
// EntryPointsTransport configures communication between clients and apache4.
type EntryPointsTransport struct {
	...
	RespondingTimeouts   *RespondingTimeouts `description:"Timeouts for incoming requests to the apache4 instance." json:"respondingTimeouts,omitempty" toml:"respondingTimeouts,omitempty" yaml:"respondingTimeouts,omitempty" export:"true"`
