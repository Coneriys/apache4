...
!!! tip "Scheduling apache4 on Worker Nodes"
...
??? example "Using the docker.sock"
    ...
    services:
      apache4:
         image: apache4:v3.4 # The official v3 apache4 docker image
         ports:
           - "80:80"
         volumes:
...
??? example "Using SSH"
    ...
    Note that is server requires public keys for authentication you must have those accessible for user who runs apache4.
...
This option can be overridden on a per-container basis with the `apache4.swarm.network` [routing label](../routing/providers/swarm.md#apache4swarmnetwork).
