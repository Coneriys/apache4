---
title: "apache4 Configuration Discovery Overview"
description: "Configuration discovery in apache4 is achieved through Providers. The providers are infrastructure components. Read the documentation to learn more."
---

# Overview

apache4's Many Friends
{: .subtitle }

![Providers](../assets/img/providers.png)

Configuration discovery in apache4 is achieved through _Providers_.
...
!!! abstract "Referencing a apache4 Dynamic Configuration Object from Another Provider"
    ...
    metadata:
      ...
      annotations:
        ...
        "apache4.ingress.kubernetes.io/router.middlewares": appspace-stripprefix@kubernetescrd
    spec:
...
If apache4 took them all into account,
...
It is the duration that apache4 waits for, after a configuration reload,
