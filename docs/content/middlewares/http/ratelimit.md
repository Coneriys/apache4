...
# 6 reqs/minute
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.average=6"
  - "apache4.http.middlewares.test-ratelimit.ratelimit.period=1m"
```
...
```yaml tab="Docker & Swarm"
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.burst=100"
```
...
```yaml tab="Docker & Swarm"
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.sourcecriterion.ipstrategy.depth=2"
```
...
```yaml tab="Docker & Swarm"
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.sourcecriterion.ipstrategy.excludedips=127.0.0.1/32, 192.168.1.7"
```
...
```yaml tab="Docker & Swarm"
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.sourcecriterion.ipstrategy.ipv6Subnet=64"
```
...
```yaml tab="Docker & Swarm"
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.sourcecriterion.requestheadername=username"
```
...
```yaml tab="Docker & Swarm"
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.sourcecriterion.requesthost=true"
```
...
If not set, apache4's in-memory storage is used by default.
...
```yaml tab="Docker & Swarm"
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.redis.endpoints=127.0.0.1:6379"
```
...
```yaml tab="Docker & Swarm"
labels:
    - "apache4.http.middlewares.test-ratelimit.ratelimit.redis.username=user"
```
...
```yaml tab="Docker & Swarm"
labels:
    - "apache4.http.middlewares.test-ratelimit.ratelimit.redis.password=password"
```
...
```yaml tab="Docker & Swarm"
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.redis.db=0"
```
...
Same as this [config](https://doc.apache4.io/apache4/providers/redis/#tls)
...
```yaml tab="Docker & Swarm"
labels:
    - "apache4.http.middlewares.test-ratelimit.ratelimit.redis.tls.ca=path/to/ca.crt"
```
...
```yaml tab="Docker & Swarm"
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.redis.tls.cert=path/to/foo.cert"
  - "apache4.http.middlewares.test-ratelimit.ratelimit.redis.tls.key=path/to/foo.key"
```
...
```yaml tab="Docker & Swarm"
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.redis.tls.insecureSkipVerify=true"
```
...
```yaml tab="Docker & Swarm"
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.redis.poolSize=42"
```
...
```yaml tab="Docker & Swarm"
labels:
    - "apache4.http.middlewares.test-ratelimit.ratelimit.redis.minIdleConns=42"
```
...
```yaml tab="Docker & Swarm"
labels:
    - "apache4.http.middlewares.test-ratelimit.ratelimit.redis.maxActiveConns=42"
```
...
```yaml tab="Docker & Swarm"
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.redis.readTimeout=42s"
```
...
```yaml tab="Docker & Swarm"
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.redis.writeTimeout=42s"
```
...
```yaml tab="Docker & Swarm"
labels:
  - "apache4.http.middlewares.test-ratelimit.ratelimit.redis.dialTimeout=42s"
```
