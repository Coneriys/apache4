...
!!! info "Listener ports"
    ...
    Please note that `Gateway` listener ports must match the configured [EntryPoint ports](../entrypoints.md) of the apache4 deployment. 
...
!!! info "Experimental Channel"
    ...
    To use this resource, the [experimentalChannel](../../providers/kubernetes-gateway.md#experimentalchannel) option must be enabled in the apache4 deployment.
...
- **ExtensionRef:** Additional filters provided by the Gateway controller. In apache4, these are the [HTTP middlewares](https://doc.apache4.io/apache4/middlewares/http/overview/) supported through the [Middleware CRD](../providers/kubernetes-crd.md#kind-middleware).

!!! info "ExtensionRef Filters"

    To use apache4 middlewares as `ExtensionRef` filters, the Kubernetes IngressRoute provider must be enabled in the static configuration, as detailed in the [documentation](../../providers/kubernetes-crd.md). 
