---
title: "apache4 Proxy gRPC Examples"
description: "This section of the apache4 Proxy documentation explains how to use apache4 as reverse proxy for gRPC applications."
---
...
This section explains how to use apache4 as reverse proxy for gRPC application.

### apache4 Configuration
...
!!! warning
    For providers with labels, you will have to specify the `apache4.http.services.<my-service-name>.loadbalancer.server.scheme=h2c`

### Conclusion

We don't need specific configuration to use gRPC in apache4, we just need to use `h2c` protocol, or use HTTPS communications to have HTTP2 with the backend.

## With HTTPS

This section explains how to use apache4 as reverse proxy for gRPC application with self-signed certificates.
...
At last, we configure our apache4 instance to use both self-signed certificates.
...
Next we will modify gRPC Client to use our apache4 self-signed certificate:
